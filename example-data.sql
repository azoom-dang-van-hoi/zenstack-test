...
INSERT INTO `parking` (`organization_id`, `name`, `zip`, `address`) VALUES ('2', 'Parking 2', '1234567', 'HN');

INSERT INTO `parking_contract` (`parking_id`, `status`) 
VALUES ('1', '1'), ('2', '1'), ('3', '1'), ('4', '1'), ('5', '1'), ('6', '1');

INSERT INTO `user_procedure` (`parking_contract_id`, `status`, `type`) VALUES ('1', '1', '2');
INSERT INTO `user_procedure` (`organization_id`, `status`, `type`) VALUES ('1', '1', '1');
INSERT INTO `user_procedure` (`organization_id`, `status`, `type`) VALUES ('2', '1', '1');
INSERT INTO `user_procedure` (`parking_contract_id`, `status`, `type`) VALUES ('6', '1', '2');
INSERT INTO `user_procedure` (`parking_contract_id`, `status`, `type`) VALUES ('2', '1', '3');

INSERT INTO `contractor` (`name`, `email`) 
VALUES ('Contractor 1', 'contractor-1@gmail.com'), ('Contractor 2', 'contractor-2@gmail.com');

UPDATE `parking_contract` SET `contractor_id` = '1' WHERE (`id` = '1');
UPDATE `parking_contract` SET `contractor_id` = '1' WHERE (`id` = '2');
UPDATE `parking_contract` SET `contractor_id` = '2' WHERE (`id` = '3');
UPDATE `parking_contract` SET `contractor_id` = '2' WHERE (`id` = '4');
UPDATE `parking_contract` SET `contractor_id` = '1' WHERE (`id` = '5');
UPDATE `parking_contract` SET `contractor_id` = '2' WHERE (`id` = '6');

UPDATE `user_procedure` SET `contractor_id` = '1' WHERE (`id` = '3');
UPDATE `user_procedure` SET `contractor_id` = '2' WHERE (`id` = '4');

INSERT INTO `notification` (`created_organization_id`, `content_type`, `history_id`, `contractor_id`, `email`, `content`, `detail_title`, `detail_url`, `target`) 
VALUES ('1', '13', 'dhdhdhdhueud1', 1, 'contractor-1@gmail.com', 'demo', 'demo', 'url', '1'),
('1', '13', 'dhdhdhdhueud2', 1, 'contractor-1@gmail.com', 'demo', 'demo', 'url', '1'),
('2', '13', 'dhdhdhdhueud2', 2, 'contractor-2@gmail.com', 'demo', 'demo', 'url', '1');
